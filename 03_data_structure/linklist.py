...
linklist01.init_list(l_list)
# linklist01.append("tail")
# linklist01.head_insert("head")
# linklist01.insert(100,"test")
# print(linklist01.delete(3))
# linklist01.remove(100)
print(linklist01.get_data(3))
linklist01.show_list()
