...
* 什么是网络 : 计算机网络功能主要包括实现资源共享，实现数据信息的快速传递。
  ...
  ![](06_network_programmingn/img/1.jpg)

  ![](06_network_programmingn/img/2.png)
...
* 面临问题
  ...
  ![](06_network_programmingn/img/4.jpg)



* OSI 7层模型

  ![](06_network_programmingn/img/5.jpg)
...
* TCP/IP模型
  ...
  * 实际工作中以TCP/IP模型为工作标准流程
  ...
  ![](06_network_programmingn/img/6.jpg)
...
* 需要应用工程师做的工作 ： 编写应用工功能，明确对方地址，选择传输服务。
    ...
    ![](06_network_programmingng/img/7.jpg)
...
* 端口号
  ...
  * 端口：网络地址的一部分，在一台计算机上，每个网络程序对应一个端口。
    ...
    ![](06_network_programmingng/img/3.png)
...
* 客户端（Client） ：也称为用户端，是指与服务端相对应，为客户提供一定应用功能的程序，我们平时使用的手机或者电脑上的程序基本都是客户端程序。
  ...
  ![](06_network_programmingn/img/10.jpg)
...
* 套接字(Socket) ： 实现网络编程进行数据传输的一种技术手段,网络上各种各样的网络服务大多都是基于 Socket 来完成通信的。
  ...
  ![](06_network_programmingn/img/9.jpg)
...
* 服务端客户端流程
  ...
  ![](06_network_programmingn/img/11.png)
...
![](06_network_programming/img/1_scws.png)
...
![](06_network_programming/img/1_schs.png)

#### 1.3.2 TCP服务端



![](06_network_programming/img/1_TCP_Server.png)
...
![](06_network_programming/img/11.jpg)
...
![](06_network_programming/img/1_TCP_Client.png)
...
![](06_network_programmingng/img/12.png)
...
* tcp粘包问题
  ...
  * 产生原因
    ...
    * tcp以字节流方式进行数据传输，在接收时不区分消息边界
    ...
    ![](06_network_programmingng/img/13.jpg)
...
![](06_network_programming/img/14.png)



#### 1.4.2 TCP协议首部（了解）

![](06_network_programming/img/1_tcpsjb.png)
...
* 多任务
  ...
  ![](06_network_programmingn/img/13.png)
...
* 计算机原理 
  ...
  * CPU：计算机硬件的核心部件，用于对任务进行执行运算。
    ...
    ![](06_network_programmingng/img/14.jpg)

  * 操作系统调用CPU执行任务

    ![](06_network_programmingng/img/15.png)

  * cpu轮训机制 ： cpu都在多个任务之间快速的切换执行，切换速度在微秒级别，其实cpu同时只执行一个任务，但是因为切换太快了，从应用层看好像所有任务同时在执行。

    ![](06_network_programmingng/img/16.gif)
...
* 什么是多任务编程
  ...
  ![](06_network_programmingn/img/12.jpg)
...
* 多任务意义
  ...
  * 充分利用计算机资源，提高了任务的执行效率。
    ...
    * 在任务中无阻塞时只有并行状态才能提高效率
    ...
    ![](06_network_programmingng/img/17.jpg)

    

    * 在任务中有阻塞时并行并发都能提高效率

    ![](06_network_programmingng/img/18.jpg)
...
* 定义： 程序在计算机中的一次执行过程。
  ...
  - 进程是一个动态的过程描述，占有计算机运行资源，有一定的生命周期。
    ...
    ![](06_network_programmingng/img/19.jpg)
...
* 进程命令
  ...
  * 查看进程信息
    ...
    ![](06_network_programmingng/img/20.png)
...
​       【5】 线程的创建和销毁消耗资源远小于进程
  ...
  ![](06_network_programmingn/img/21.jpg)

#### 2.3.2 多线程编程

* 线程模块： threading

![](06_network_programming/img/22.jpg)
...
* 同步互斥机制
  ...
  * 同步 ： 同步是一种协作关系，为完成操作，多进程或者线程间形成一种协调，按照必要的步骤有序执行操作。
    ...
    ![](06_network_programmingng/img/7_tb.png)

  * 互斥 ： 互斥是一种制约关系，当一个进程或者线程占有资源时会进行加锁处理，此时其他进程线程就无法操作该资源，直到解锁后才能操作。

![](06_network_programming/img/7_hc.png)
...
![](06_network_programming/img/ss.jpg)
...
* 使用场景
  ...
  ![](06_network_programmingn/img/23.jpg)
...
* 什么是网络并发
  ...
  ![](06_network_programmingn/img/24.jpg)
...
![](06_network_programming/img/2_wzfw.png)
...
- 请求体: 请求参数或者提交内容
 ...
 ![](06_network_programmingn/img/request.jpg)
...
![](06_network_programming/img/response.png)
...
![](06_network_programming/img/25.jpg)
